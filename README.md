...
node pr-reviewer.js
```
To wire up PR reviewer with your Bitbucket project, Webhook should be configured in Bitbucket project settings with URL `http://pr-reviewer-host:3001/bitbuclet/pr-event`
